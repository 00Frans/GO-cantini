                    ...
                    if(mysqli_num_rows($chk_existing_cart_run) > 0){
                        echo 210; //existing
                            ...
                            $insert_query = "INSERT INTO carts(user_id, prod_id, prod_qty)
                                            ...
                                            */
                            $insert_query = "INSERT INTO carts(user_id, seller_id, prod_id, prod_qty)
                            SELECT '$user_id', user_id, '$prod_id', '$prod_qty'
                            FROM products
                            WHERE id = '$prod_id'";
                ...
                case "update_check_box":
                    ...
                    if (mysqli_num_rows($chk_existing_cart_run) > 0) {
                        ...
                        if ($update_query_run) {
                            ...
                            echo "Error updating checkbox value: " . mysqli_error($con);
                        }
                    } else {
                        echo "Something went wrong";
                    }
