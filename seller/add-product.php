        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <span class="fs-4 text-white">Add Product</span>
                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" name="shop_name" placeholder="Enter Shop Name" class="form-control mb-2">
                        </div>
                        <div class="col-md-4">
                          <label class="mb-0">Slug</label>
                          <input type="text" name="slug" placeholder="Enter Slug eg.(shop name + product name)" class="form-control mb-2">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                          ...
                          <input class="mx-1 mt-2" type="file" name="image" class="form-control mb-2">
                        </div>
                        <div class="row">
